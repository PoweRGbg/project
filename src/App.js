                    ...
                    <div className="tm-bg-primary-dark tm-block tm-block-taller tm-block-overflow">
                        ...
                        <div className="tm-notification-items">
                            <div className="media tm-notification-item">
                                <div className="tm-gray-circle"><img src="img/notification-01.jpg" alt="Avatar Image" className="rounded-circle"></img></div>
                            ...
                            <div className="media tm-notification-item">
                                <div className="tm-gray-circle"><img src="img/notification-02.jpg" alt="Avatar Image" className="rounded-circle"></img></div>
                                <div className="media-body">
                            ...
                            <div className="media tm-notification-item">
                                <div className="tm-gray-circle"><img src="img/notification-03.jpg" alt="Avatar Image" className="rounded-circle"></img></div>
                                <div className="media-body">
